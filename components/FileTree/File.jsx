...
const File = ({ fileName, selectContent, setCurrentContent, contentType, host, editable, topic,triggerAddFileToPersonalList }) => {
            ...
            <li onDrag={e => { console.log(e) }}>
                {
                    (isEditing) ? <input id="file-edit" onChange={e => { setFname(e.target.value) }} onBlur={async e => {
                        ...
                        <div onDoubleClick={e => triggerAddFileToPersonalList(fileName, contentType, topic)} onClick={e => {
